...
public class SmartDepasCompraVentaCompleto extends BaseParser{
	...
	public String getFieldsTitle() {
		return "OBJETO_DEL_CONTRATO|MONTO_INVERSION|MONEDA|OBLIGACIONES_ADQUIRIENTE|VIGENCIA_DE_CONTRATO|FECHA_ENTREGA|PRORROGA_DE_ENTREGA|UNIDAD|FORMA_DE_PAGO|RENDIMIENTO_GARANTIZADO|FECHA_PAGO_RENDIMIENTOS|PORC_RENDIMIENTOS|MESES_RENDIMIENTOS";
	}
