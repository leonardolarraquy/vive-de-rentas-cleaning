...
public class HoolBam02Completo extends BaseParser{
	...
	public String getFieldsTitle() {
		return "PARTICIPACION_NUM|UNIDAD|DERECHO_DE_USO|MONTO_INVERSION|MONEDA|OBLIGACIONES_ENAJENANTE|DEVOLUCION_POR_TERMINACION_DE_CONTRATO|TIEMPO_DE_ENTREGA|FECHA_DE_ENTREGA|PRORROGA_DE_ENTREGA|CARTA_RENDIMIENTO|FECHA_PAGO_RENDIMIENTOS_STR|FECHA_PAGO_RENDIMIENTOS|PORC_RENDIMIENTOS|MESES_RENDIMIENTOS";
	}
