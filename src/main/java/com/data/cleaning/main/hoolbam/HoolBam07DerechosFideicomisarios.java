...
public class HoolBam07DerechosFideicomisarios extends BaseParser {
	...
	public String getFieldsTitle() {
		return "TORRE|PORC_PROPIEDAD|MONTO_INVERSION|MONEDA|MONTO_APARTADO|MONTO_LIQUIDACION|OBLIGACIONES_ENAJENANTE|VIGENCIA_DE_CONTRATO|PRORROGA_DE_ENTREGA|FECHA_ENTREGA|RENDIMIENTO_GARANTIZADO|FECHA_PAGO_RENDIMIENTOS|PORC_RENDIMIENTOS|MESES_RENDIMIENTOS|CARTA_GARANTIA|EQUITY_INSTANTANEO|MONTO_EQUITY";
	}
